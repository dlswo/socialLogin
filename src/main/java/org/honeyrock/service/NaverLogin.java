...
public class NaverLogin {
	...
	public static UserVO changeData(JsonNode userInfo) {
		...
		vo.setUser_snsId(properties.path("id").asText());
		
		if(properties.has("nickname")) {
			vo.setUser_name(properties.path("nickname").asText());
			vo.setUser_profileImagePath(properties.path("profile_image").asText());
			vo.setUser_ages(properties.path("age").asText());
			vo.setUser_sex(properties.path("gender").asText());
			vo.setUser_email(properties.path("email").asText());
			vo.setUser_birth(properties.path("birthday").asText());
		}
