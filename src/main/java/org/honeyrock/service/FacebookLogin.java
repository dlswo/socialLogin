...
public class FacebookLogin {
	...
	public static UserVO changeData(JsonNode userInfo) {
		...
		vo.setUser_snsId(userInfo.path("id").asText());
		vo.setUser_name(userInfo.path("name").asText());
		vo.setUser_profileImagePath(userInfo.path("picture").path("data").path("url").asText());
		vo.setUser_email(userInfo.path("email").asText());
		vo.setUser_sex(userInfo.path("gender").asText());
		vo.setUser_ages(userInfo.path("age_range").path("min").asText());
		vo.setUser_birth(userInfo.path("birthday").asText());
